...
def play_music():
    music_dir = r"E:\FSDS Inception BD\Python\Inception-FSDS-Python-code-\project\jarves ai assist\JARVIS-Voice-Assistant-System\music"
    try: 
...
while True:
    ...
    if "your name" in query:
        ...
        speak("Hi sir,i am Jarvis made by Apurbo Sharma")
    ...
    # Small talk
    elif "hear me" in query or "jarvis" in query:
